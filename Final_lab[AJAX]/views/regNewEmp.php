     ...
     <td width="30%">
        <b> <h3> Accounts </h3></b>
         ...
         <ul>
          ...
          <li> <a href="./regNewEmp.php"> Add Employer </a> </li>
          <li> <a href="./updateemployer.php"> Update Employer </a> </li>
          <li> <a href="./deleteemployer.php"> Delete Employer </a> </li>
         </ul>
     </td>

        <th width="40%"> 
        <form method="POST" action="../controller/regNewEmpcheck.php" onsubmit="return getNewEmp()">
        <legend>Employee Registration</legend><br>
                        ...
                        Confirm password:
                         ...
                         <input type="submit" name="submit" value="Submit" onclick="getNewEmp()"/>
</form>
                         </th>
